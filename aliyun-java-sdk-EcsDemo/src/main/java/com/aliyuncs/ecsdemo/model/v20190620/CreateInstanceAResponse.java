...
import com.aliyuncs.ecsdemo.transform.v20190620.CreateInstanceAResponseUnmarshaller;
 ...
 * @version 
 */
public class CreateInstanceAResponse extends AcsResponse {
	...
	@Override
	public CreateInstanceAResponse getInstance(UnmarshallerContext context) {
		return	CreateInstanceAResponseUnmarshaller.unmarshall(this, context);
	}
}
