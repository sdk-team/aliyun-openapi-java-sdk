 ...
 * @version 
 */
public class ModifyInstanceVpcAttributeRequest extends RoaAcsRequest<ModifyInstanceVpcAttributeResponse> {
	...
	public ModifyInstanceVpcAttributeRequest() {
		super("EcsDemo", "2019-06-26", "ModifyInstanceVpcAttribute");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/instance/[InstanceId]/vpc");
