 ...
 * @version 
 */
public class CreateMemoryResouceRequest extends RpcAcsRequest<CreateMemoryResouceResponse> {
	...
	public CreateMemoryResouceRequest() {
		super("EcsDemo", "2019-06-20", "CreateMemoryResouce");
	...
	public void setExtraParams(String extraParams) {
		...
		if(extraParams != null){
			putQueryParameter("ExtraParams", extraParams);
		}
	}
	...
	public void setIdentityDTO(String identityDTO) {
		...
		if(identityDTO != null){
			putQueryParameter("IdentityDTO", identityDTO);
		}
	}

	@Override
	public Class<CreateMemoryResouceResponse> getResponseClass() {
		return CreateMemoryResouceResponse.class;
	}
