 ...
 * @version 
 */
public class HsfMockRequest extends RpcAcsRequest<HsfMockResponse> {
	...
	public HsfMockRequest() {
		super("EcsDemo", "2019-06-20", "HsfMock");
	...
	@Override
	public Class<HsfMockResponse> getResponseClass() {
		return HsfMockResponse.class;
	}
