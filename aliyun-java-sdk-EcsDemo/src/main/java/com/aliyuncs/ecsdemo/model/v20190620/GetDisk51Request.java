 ...
 * @version 
 */
public class GetDisk51Request extends RpcAcsRequest<GetDisk51Response> {
	...
	private Long id;
	public GetDisk51Request() {
		super("EcsDemo", "2019-06-20", "GetDisk51");
	...
	@Override
	public Class<GetDisk51Response> getResponseClass() {
		return GetDisk51Response.class;
	}
