 ...
 * @version 
 */
public class ListDisks00Request extends RpcAcsRequest<ListDisks00Response> {
	...
	private Long id;
	public ListDisks00Request() {
		super("EcsDemo", "2019-06-20", "ListDisks00");
	...
	@Override
	public Class<ListDisks00Response> getResponseClass() {
		return ListDisks00Response.class;
	}
