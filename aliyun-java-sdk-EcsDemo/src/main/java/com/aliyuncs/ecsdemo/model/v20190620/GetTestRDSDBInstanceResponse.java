...
import com.aliyuncs.ecsdemo.transform.v20190620.GetTestRDSDBInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class GetTestRDSDBInstanceResponse extends AcsResponse {
	...
	@Override
	public GetTestRDSDBInstanceResponse getInstance(UnmarshallerContext context) {
		return	GetTestRDSDBInstanceResponseUnmarshaller.unmarshall(this, context);
	}
