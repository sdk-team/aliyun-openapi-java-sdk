 ...
 * @version 
 */
public class GetInstance89Request extends RpcAcsRequest<GetInstance89Response> {
	...
	private Long id;
	public GetInstance89Request() {
		super("EcsDemo", "2019-06-20", "GetInstance89");
	...
	@Override
	public Class<GetInstance89Response> getResponseClass() {
		return GetInstance89Response.class;
	}
