 ...
 * @version 
 */
public class GetDisk21Request extends RpcAcsRequest<GetDisk21Response> {
	...
	private Long id;
	public GetDisk21Request() {
		super("EcsDemo", "2019-06-20", "GetDisk21");
	...
	@Override
	public Class<GetDisk21Response> getResponseClass() {
		return GetDisk21Response.class;
	}
