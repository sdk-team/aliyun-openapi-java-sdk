 ...
 * @version 
 */
public class CreateInstanceARequest extends RpcAcsRequest<CreateInstanceAResponse> {
	...
	public CreateInstanceARequest() {
		super("EcsDemo", "2019-06-20", "CreateInstanceA");
	...
	@Override
	public Class<CreateInstanceAResponse> getResponseClass() {
		return CreateInstanceAResponse.class;
	}
