 ...
 * @version 
 */
public class GetInstance01Request extends RpcAcsRequest<GetInstance01Response> {
	...
	private Long id;
	public GetInstance01Request() {
		super("EcsDemo", "2019-06-20", "GetInstance01");
	...
	@Override
	public Class<GetInstance01Response> getResponseClass() {
		return GetInstance01Response.class;
	}
