 ...
 * @version 
 */
public class ModifyDiskAttributeRequest extends RoaAcsRequest<ModifyDiskAttributeResponse> {
	...
	public ModifyDiskAttributeRequest() {
		super("EcsDemo", "2019-06-26", "ModifyDiskAttribute");
		setProtocol(ProtocolType.HTTPS);
		setUriPattern("/disk/[DiskId]");
	...
	public void setDiskId(String diskId) {
		this.diskId = diskId;
		if(diskId != null){
			putBodyParameter("DiskId", diskId);
		}
	}
