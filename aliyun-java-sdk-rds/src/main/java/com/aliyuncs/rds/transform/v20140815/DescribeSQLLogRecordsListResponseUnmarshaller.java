...
public class DescribeSQLLogRecordsListResponseUnmarshaller {
	...
	public static DescribeSQLLogRecordsListResponse unmarshall(DescribeSQLLogRecordsListResponse describeSQLLogRecordsListResponse, UnmarshallerContext context) {
		...
		describeSQLLogRecordsListResponse.setDBInstanceName(context.stringValue("DescribeSQLLogRecordsListResponse.DBInstanceName"));
		...
		describeSQLLogRecordsListResponse.setPagingID(context.stringValue("DescribeSQLLogRecordsListResponse.PagingID"));
		...
		describeSQLLogRecordsListResponse.setPageNumbers(context.integerValue("DescribeSQLLogRecordsListResponse.PageNumbers"));
		describeSQLLogRecordsListResponse.setItemsNumbers(context.integerValue("DescribeSQLLogRecordsListResponse.ItemsNumbers"));
		describeSQLLogRecordsListResponse.setJobId(context.stringValue("DescribeSQLLogRecordsListResponse.JobId"));
		describeSQLLogRecordsListResponse.setFinish(context.stringValue("DescribeSQLLogRecordsListResponse.Finish"));
		...
		for (int i = 0; i < context.lengthValue("DescribeSQLLogRecordsListResponse.Items.Length"); i++) {
			...
			sQLLogRecord.setState(context.stringValue("DescribeSQLLogRecordsListResponse.Items["+ i +"].State"));
			sQLLogRecord.setExecuteTime(context.stringValue("DescribeSQLLogRecordsListResponse.Items["+ i +"].ExecuteTime"));
			sQLLogRecord.setThreadID(context.integerValue("DescribeSQLLogRecordsListResponse.Items["+ i +"].ThreadID"));
