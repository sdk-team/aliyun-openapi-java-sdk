...
public class DescribeTemplateSqlDetailResponseUnmarshaller {
	...
	public static DescribeTemplateSqlDetailResponse unmarshall(DescribeTemplateSqlDetailResponse describeTemplateSqlDetailResponse, UnmarshallerContext context) {
		...
		describeTemplateSqlDetailResponse.setJobId(context.stringValue("DescribeTemplateSqlDetailResponse.JobId"));
		describeTemplateSqlDetailResponse.setFinish(context.stringValue("DescribeTemplateSqlDetailResponse.Finish"));
		...
		for (int i = 0; i < context.lengthValue("DescribeTemplateSqlDetailResponse.Items.Length"); i++) {
			...
			templateSqlDetail.setState(context.stringValue("DescribeTemplateSqlDetailResponse.Items["+ i +"].State"));
			templateSqlDetail.setExecuteTime(context.stringValue("DescribeTemplateSqlDetailResponse.Items["+ i +"].ExecuteTime"));
			templateSqlDetail.setThreadID(context.integerValue("DescribeTemplateSqlDetailResponse.Items["+ i +"].ThreadID"));
