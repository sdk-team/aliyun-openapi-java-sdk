...
import com.aliyuncs.rds.model.v20130528.DescribeBackupsResponse;
import com.aliyuncs.rds.model.v20130528.DescribeBackupsResponse.Backup;
...
public class DescribeBackupsResponseUnmarshaller {
	...
	public static DescribeBackupsResponse unmarshall(DescribeBackupsResponse describeBackupsResponse, UnmarshallerContext context) {
		...
		for (int i = 0; i < context.lengthValue("DescribeBackupsResponse.Backups.Length"); i++) {
			...
			backup.setDownloadable(context.stringValue("DescribeBackupsResponse.Backups["+ i +"].Downloadable"));
			...
			backup.setBackupId(context.longValue("DescribeBackupsResponse.Backups["+ i +"].BackupId"));
			backup.setDBInstanceId(context.stringValue("DescribeBackupsResponse.Backups["+ i +"].DBInstanceId"));
