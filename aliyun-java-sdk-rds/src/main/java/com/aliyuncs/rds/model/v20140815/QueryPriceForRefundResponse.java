...
import com.aliyuncs.rds.transform.v20140815.QueryPriceForRefundResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryPriceForRefundResponse extends AcsResponse {
	...
	@Override
	public QueryPriceForRefundResponse getInstance(UnmarshallerContext context) {
		return	QueryPriceForRefundResponseUnmarshaller.unmarshall(this, context);
	}
}
