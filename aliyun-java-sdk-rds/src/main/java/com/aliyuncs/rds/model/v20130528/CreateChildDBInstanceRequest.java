...
public class CreateChildDBInstanceRequest extends RpcAcsRequest<CreateChildDBInstanceResponse> {
	...
	public String getRetainInstance() {
		return this.retainInstance;
	}

	public void setRetainInstance(String retainInstance) {
		this.retainInstance = retainInstance;
		if(retainInstance != null){
			putQueryParameter("RetainInstance", retainInstance);
		}
	}
	...
	@Override
	public Class<CreateChildDBInstanceResponse> getResponseClass() {
		return CreateChildDBInstanceResponse.class;
	}
