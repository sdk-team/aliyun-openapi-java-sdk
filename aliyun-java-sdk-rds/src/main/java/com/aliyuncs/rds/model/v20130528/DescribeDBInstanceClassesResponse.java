...
import com.aliyuncs.rds.transform.v20130528.DescribeDBInstanceClassesResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeDBInstanceClassesResponse extends AcsResponse {
	...
	@Override
	public DescribeDBInstanceClassesResponse getInstance(UnmarshallerContext context) {
		return	DescribeDBInstanceClassesResponseUnmarshaller.unmarshall(this, context);
	}
}
