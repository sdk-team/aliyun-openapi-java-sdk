...
import com.aliyuncs.rds.transform.v20140815.QueryPriceMultiForDeferResponseUnmarshaller;
 ...
 * @version 
 */
public class QueryPriceMultiForDeferResponse extends AcsResponse {
	...
	@Override
	public QueryPriceMultiForDeferResponse getInstance(UnmarshallerContext context) {
		return	QueryPriceMultiForDeferResponseUnmarshaller.unmarshall(this, context);
	}
}
