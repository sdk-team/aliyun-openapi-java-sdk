...
public class EnableSqlLogDistributionRequest extends RpcAcsRequest<EnableSqlLogDistributionResponse> {
	...
	public void setLoghubRegion(String loghubRegion) {
		...
		if(loghubRegion != null){
			putQueryParameter("LoghubRegion", loghubRegion);
		}
	}
	...
	@Override
	public Class<EnableSqlLogDistributionResponse> getResponseClass() {
		return EnableSqlLogDistributionResponse.class;
	}
