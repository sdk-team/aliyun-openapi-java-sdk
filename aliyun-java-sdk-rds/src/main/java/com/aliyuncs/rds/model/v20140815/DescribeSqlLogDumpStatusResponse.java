...
import com.aliyuncs.rds.transform.v20140815.DescribeSqlLogDumpStatusResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeSqlLogDumpStatusResponse extends AcsResponse {
	...
	@Override
	public DescribeSqlLogDumpStatusResponse getInstance(UnmarshallerContext context) {
		return	DescribeSqlLogDumpStatusResponseUnmarshaller.unmarshall(this, context);
	}
}
