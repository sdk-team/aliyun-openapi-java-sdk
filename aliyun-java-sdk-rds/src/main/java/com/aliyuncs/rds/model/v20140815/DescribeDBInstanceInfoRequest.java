...
public class DescribeDBInstanceInfoRequest extends RpcAcsRequest<DescribeDBInstanceInfoResponse> {
	...
	public void setAddressPort(String addressPort) {
		...
		if(addressPort != null){
			putQueryParameter("AddressPort", addressPort);
		}
	}
	...
	public void setAddressIP(String addressIP) {
		...
		if(addressIP != null){
			putQueryParameter("AddressIP", addressIP);
		}
	}

	@Override
	public Class<DescribeDBInstanceInfoResponse> getResponseClass() {
		return DescribeDBInstanceInfoResponse.class;
	}
