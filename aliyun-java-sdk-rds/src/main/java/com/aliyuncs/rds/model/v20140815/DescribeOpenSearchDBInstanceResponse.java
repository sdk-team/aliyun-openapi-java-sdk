...
import com.aliyuncs.rds.transform.v20140815.DescribeOpenSearchDBInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeOpenSearchDBInstanceResponse extends AcsResponse {
	...
	@Override
	public DescribeOpenSearchDBInstanceResponse getInstance(UnmarshallerContext context) {
		return	DescribeOpenSearchDBInstanceResponseUnmarshaller.unmarshall(this, context);
	}
}
