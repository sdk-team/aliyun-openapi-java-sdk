...
import com.aliyuncs.rds.transform.v20140815.ModifyOpenSearchDBInstanceResponseUnmarshaller;
 ...
 * @version 
 */
public class ModifyOpenSearchDBInstanceResponse extends AcsResponse {
	...
	@Override
	public ModifyOpenSearchDBInstanceResponse getInstance(UnmarshallerContext context) {
		return	ModifyOpenSearchDBInstanceResponseUnmarshaller.unmarshall(this, context);
	}
}
