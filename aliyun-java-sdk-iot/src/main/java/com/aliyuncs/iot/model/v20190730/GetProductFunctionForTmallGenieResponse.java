...
import com.aliyuncs.iot.transform.v20190730.GetProductFunctionForTmallGenieResponseUnmarshaller;
 ...
 * @version 
 */
public class GetProductFunctionForTmallGenieResponse extends AcsResponse {
	...
	@Override
	public GetProductFunctionForTmallGenieResponse getInstance(UnmarshallerContext context) {
		return	GetProductFunctionForTmallGenieResponseUnmarshaller.unmarshall(this, context);
	}
}
