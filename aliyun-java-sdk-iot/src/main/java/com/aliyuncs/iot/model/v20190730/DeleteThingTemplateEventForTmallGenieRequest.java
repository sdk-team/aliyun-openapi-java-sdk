 ...
 * @version 
 */
public class DeleteThingTemplateEventForTmallGenieRequest extends RpcAcsRequest<DeleteThingTemplateEventForTmallGenieResponse> {
	
	public DeleteThingTemplateEventForTmallGenieRequest() {
		super("Iot", "2019-07-30", "DeleteThingTemplateEventForTmallGenie", "Iot");
	}
	...
	@Override
	public Class<DeleteThingTemplateEventForTmallGenieResponse> getResponseClass() {
		return DeleteThingTemplateEventForTmallGenieResponse.class;
	}
