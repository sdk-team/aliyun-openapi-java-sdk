...
import com.aliyuncs.iot.transform.v20190730.ListServicePoolForTmallGenieResponseUnmarshaller;
 ...
 * @version 
 */
public class ListServicePoolForTmallGenieResponse extends AcsResponse {
	...
	@Override
	public ListServicePoolForTmallGenieResponse getInstance(UnmarshallerContext context) {
		return	ListServicePoolForTmallGenieResponseUnmarshaller.unmarshall(this, context);
	}
}
