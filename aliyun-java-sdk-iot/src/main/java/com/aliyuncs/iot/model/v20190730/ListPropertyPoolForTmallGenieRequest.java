...
public class ListPropertyPoolForTmallGenieRequest extends RpcAcsRequest<ListPropertyPoolForTmallGenieResponse> {
	...
	public ListPropertyPoolForTmallGenieRequest() {
		super("Iot", "2019-07-30", "ListPropertyPoolForTmallGenie");
	...
	@Override
	public Class<ListPropertyPoolForTmallGenieResponse> getResponseClass() {
		return ListPropertyPoolForTmallGenieResponse.class;
	}
