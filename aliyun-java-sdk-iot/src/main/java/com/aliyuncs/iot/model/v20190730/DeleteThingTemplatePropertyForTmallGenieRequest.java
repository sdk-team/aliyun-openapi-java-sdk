 ...
 * @version 
 */
public class DeleteThingTemplatePropertyForTmallGenieRequest extends RpcAcsRequest<DeleteThingTemplatePropertyForTmallGenieResponse> {
	
	public DeleteThingTemplatePropertyForTmallGenieRequest() {
		super("Iot", "2019-07-30", "DeleteThingTemplatePropertyForTmallGenie", "Iot");
	}
	...
	@Override
	public Class<DeleteThingTemplatePropertyForTmallGenieResponse> getResponseClass() {
		return DeleteThingTemplatePropertyForTmallGenieResponse.class;
	}
