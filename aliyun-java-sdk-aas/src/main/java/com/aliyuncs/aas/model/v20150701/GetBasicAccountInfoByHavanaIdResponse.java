...
import com.aliyuncs.aas.transform.v20150701.GetBasicAccountInfoByHavanaIdResponseUnmarshaller;
 ...
 * @version 
 */
public class GetBasicAccountInfoByHavanaIdResponse extends AcsResponse {
	...
	@Override
	public GetBasicAccountInfoByHavanaIdResponse getInstance(UnmarshallerContext context) {
		return	GetBasicAccountInfoByHavanaIdResponseUnmarshaller.unmarshall(this, context);
	}
}
