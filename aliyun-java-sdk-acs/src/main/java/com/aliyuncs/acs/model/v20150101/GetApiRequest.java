 ...
 * @version 
 */
public class GetApiRequest extends RoaAcsRequest<GetApiResponse> {
	
	public GetApiRequest() {
		super("Acs", "2015-01-01", "GetApi", "1.0.3");
	...
	@Override
	public Class<GetApiResponse> getResponseClass() {
		return GetApiResponse.class;
	}
