...
import com.aliyuncs.acs.transform.v20150101.GetApiBackupResponseUnmarshaller;
 ...
 * @version 
 */
public class GetApiBackupResponse extends AcsResponse {
	...
	@Override
	public GetApiBackupResponse getInstance(UnmarshallerContext context) {
		return	GetApiBackupResponseUnmarshaller.unmarshall(this, context);
	}
}
