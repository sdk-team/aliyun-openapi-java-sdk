...
public class PutAccountBindingRequest extends RoaAcsRequest<PutAccountBindingResponse> {
	...
	public void setAliyunUid(Long aliyunUid) {
		...
		if(aliyunUid != null){
			putPathParameter("AliyunUid", aliyunUid.toString());
		}
	}
	...
	public void setBucEmpId(String bucEmpId) {
		...
		if(bucEmpId != null){
			putPathParameter("BucEmpId", bucEmpId);
		}
	}
	...
	@Override
	public Class<PutAccountBindingResponse> getResponseClass() {
		return PutAccountBindingResponse.class;
	}
