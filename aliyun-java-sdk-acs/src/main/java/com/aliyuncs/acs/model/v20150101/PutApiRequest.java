 ...
 * @version 
 */
public class PutApiRequest extends RoaAcsRequest<PutApiResponse> {
	
	public PutApiRequest() {
		super("Acs", "2015-01-01", "PutApi", "1.0.3");
	...
	@Override
	public Class<PutApiResponse> getResponseClass() {
		return PutApiResponse.class;
	}
