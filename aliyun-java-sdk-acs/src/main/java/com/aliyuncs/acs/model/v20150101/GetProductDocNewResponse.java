...
import com.aliyuncs.acs.transform.v20150101.GetProductDocNewResponseUnmarshaller;
 ...
 * @version 
 */
public class GetProductDocNewResponse extends AcsResponse {
	...
	@Override
	public GetProductDocNewResponse getInstance(UnmarshallerContext context) {
		return	GetProductDocNewResponseUnmarshaller.unmarshall(this, context);
	}
}
