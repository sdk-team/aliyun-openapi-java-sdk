...
import com.aliyuncs.acs.transform.v20150101.GetApiDocumentResponseUnmarshaller;
 ...
 * @version 
 */
public class GetApiDocumentResponse extends AcsResponse {
	...
	@Override
	public GetApiDocumentResponse getInstance(UnmarshallerContext context) {
		return	GetApiDocumentResponseUnmarshaller.unmarshall(this, context);
	}
}
