...
import com.aliyuncs.acs.transform.v20150101.GetVersionWithAllApiResponseUnmarshaller;
 ...
 * @version 
 */
public class GetVersionWithAllApiResponse extends AcsResponse {
	...
	@Override
	public GetVersionWithAllApiResponse getInstance(UnmarshallerContext context) {
		return	GetVersionWithAllApiResponseUnmarshaller.unmarshall(this, context);
	}
}
