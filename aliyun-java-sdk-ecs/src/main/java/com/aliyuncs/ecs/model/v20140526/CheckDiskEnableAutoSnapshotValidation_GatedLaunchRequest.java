...
public class CheckDiskEnableAutoSnapshotValidation_GatedLaunchRequest extends RpcAcsRequest<CheckDiskEnableAutoSnapshotValidation_GatedLaunchResponse> {
	...
	@Override
	public Class<CheckDiskEnableAutoSnapshotValidation_GatedLaunchResponse> getResponseClass() {
		return CheckDiskEnableAutoSnapshotValidation_GatedLaunchResponse.class;
	}
