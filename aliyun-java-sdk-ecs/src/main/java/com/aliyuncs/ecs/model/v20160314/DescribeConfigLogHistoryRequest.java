...
public class DescribeConfigLogHistoryRequest extends RpcAcsRequest<DescribeConfigLogHistoryResponse> {
	...
	public void setChronologicalOrder(String chronologicalOrder) {
		...
		if(chronologicalOrder != null){
			putQueryParameter("ChronologicalOrder", chronologicalOrder);
		}
	}
	...
	@Override
	public Class<DescribeConfigLogHistoryResponse> getResponseClass() {
		return DescribeConfigLogHistoryResponse.class;
	}
