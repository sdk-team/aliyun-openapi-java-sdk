...
import com.aliyuncs.ecs.transform.v20140526.CheckAutoSnapshotPolicy_GatedLaunchResponseUnmarshaller;
 ...
 * @version 
 */
public class CheckAutoSnapshotPolicy_GatedLaunchResponse extends AcsResponse {
	...
	@Override
	public CheckAutoSnapshotPolicy_GatedLaunchResponse getInstance(UnmarshallerContext context) {
		return	CheckAutoSnapshotPolicy_GatedLaunchResponseUnmarshaller.unmarshall(this, context);
	}
}
