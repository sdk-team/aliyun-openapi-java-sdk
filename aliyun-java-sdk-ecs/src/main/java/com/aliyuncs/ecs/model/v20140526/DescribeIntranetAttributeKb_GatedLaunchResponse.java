...
import com.aliyuncs.ecs.transform.v20140526.DescribeIntranetAttributeKb_GatedLaunchResponseUnmarshaller;
 ...
 * @version 
 */
public class DescribeIntranetAttributeKb_GatedLaunchResponse extends AcsResponse {
	...
	@Override
	public DescribeIntranetAttributeKb_GatedLaunchResponse getInstance(UnmarshallerContext context) {
		return	DescribeIntranetAttributeKb_GatedLaunchResponseUnmarshaller.unmarshall(this, context);
	}
}
