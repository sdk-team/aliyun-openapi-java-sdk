...
import com.aliyuncs.actiontrail.model.v20150928.LookupEventsResponse;
...
public class LookupEventsResponseUnmarshaller {
	...
	public static LookupEventsResponse unmarshall(LookupEventsResponse lookupEventsResponse, UnmarshallerContext context) {
		...
		lookupEventsResponse.setEvents(context.stringValue("LookupEventsResponse.Events"));
		...
		lookupEventsResponse.setParam(context.stringValue("LookupEventsResponse.Param"));
		lookupEventsResponse.setResult(context.stringValue("LookupEventsResponse.Result"));
